package com.rafif.recipeapp.data
...
object DataRecipe {
    ...
    val listBreakfast: ArrayList<Recipe>
    get() {
    ...
    val listDessert: ArrayList<Recipe>
        get() {
            val listDessert = arrayListOf<Recipe>()
    ...
    val listVegetarian: ArrayList<Recipe>
        get() {
            val listVegetarian = arrayListOf<Recipe>()
